...
sudo pacman -S polkit swaybg waybar xorg-xwayland xdg-utils fakeroot pulseaudio mpv imv imagemagick gnome-keyring libsecret grim slurp wl-clipboard wf-recorder jq swayimg gtk3
```
